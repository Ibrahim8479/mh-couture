    ...
    <div class="admin-container">
        <aside class="sidebar">
            ...
            <nav class="admin-nav">
                ...
                <a href="admin.php?section=messages" class="nav-link" data-section="messages">
                    💬 Messages
                </a>
        ...
        <main class="main-content">
            ...
            <!-- CUSTOM ORDERS SECTION - ID CORRIGÉ -->
            <section id="custom_orders-section" class="content-section">
                <div class="section-header">
